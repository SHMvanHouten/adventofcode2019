...
class Day07Test {
    ...
    inner class Part1 {
        ...
        internal fun testInput() {
            ...
            val thrusterSettings = listOf(4L, 3L, 2L, 1L, 0L)
            assertThat(computeThrusterSignal(intCode, thrusterSettings), equalTo(43210L))
        }

        @Test
        internal fun `testInput highest signal`() {
            val intCode = IntCode(3, 15, 3, 16, 1002, 16, 10, 16, 1, 16, 15, 15, 4, 15, 99, 0, 0)
            assertThat(computeMaxThrusterSignal(intCode), equalTo(43210L))
        }
        ...
        internal fun testInput2() {
            ...
            val thrusterSettings = listOf(0L,1L,2L,3L,4L)
            assertThat(computeThrusterSignal(intCode, thrusterSettings), equalTo(54321L))
        }

        @Test
        internal fun part1() {
            assertThat(computeMaxThrusterSignal(IntCode(input)), equalTo(338603L))
        }
    }
    ...
    inner class Part2 {
        ...
        internal fun testInput() {
            ...
            val thrusterSettings = listOf(9L,8L,7L,6L,5L)

            assertThat(computeFeedbackedThrusterSignal(intCode, thrusterSettings), equalTo(139629729L))
        }
        ...
        internal fun `testInput higest signal`() {
            ...
            assertThat(maxFeedbackedThrusterSignal(intCode), equalTo(139629729L))
        }
        ...
        internal fun `testInput2 higest signal`() {
            ...
            assertThat(maxFeedbackedThrusterSignal(intCode), equalTo(18216L))
        }

        @Test
        internal fun part2() {
            assertThat(maxFeedbackedThrusterSignal(IntCode(input)), equalTo(63103596L))
        }
    }
