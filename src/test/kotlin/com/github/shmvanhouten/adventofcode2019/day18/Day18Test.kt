...
#################################################################################"""
    ...
    inner class Part2 {
        ...
        @Test
        internal fun `divide the path into 4`() {
            val input = """
                        |#######
                        |#a.#Cd#
                        |##@#@##
                        ...
                        |#cB#Ab#
                        |#######""".trimMargin()
            val parts = breakUpIntoParts(input)
            ...
            val expectedTopLeft = """
                                ...
                                |##@#
                                |####""".trimMargin().split('\n')
            assertThat(parts[0], equalTo(expectedTopLeft))

            val expectedBottomRight = """
                                        |####
                                        |#@##
                                        |#Ab#
                                        |####""".trimMargin().split('\n')
            assertThat(parts[3], equalTo(expectedBottomRight))

            val testInput = breakUpIntoParts(input)
            println(testInput[0].joinToString("\n"))
            println(testInput[3].joinToString("\n"))
        }
        ...
        internal fun `test input 1`() {
            ...
            assertThat(stepsRequiredBy4Bots(input), equalTo(8))
        }
        ...
        internal fun `test input 2`() {
            val input = """
                        ...
                        |###############
            """.trimIndent()
            assertThat(stepsRequiredBy4Bots(input), equalTo(24))
        }

        @Test
        internal fun part2() {
            assertThat(stepsRequiredBy4Bots(input), equalTo(1648))
        }
