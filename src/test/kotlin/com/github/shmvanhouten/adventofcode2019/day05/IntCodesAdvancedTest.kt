...
class IntCodesAdvancedTest {
    ...
    inner class Part1 {
        ...
        internal fun `we should support parameter modes`() {
            ...
            assertThat(Computer(intCode = intCode).run(), equalTo(listOf(1002, 4, 3, 4, 99)))
        }
    ...
    inner class Part2 {
        ...
        inner class `We support less than instruction` {
            ...
            internal fun `1 is less than 7`() {
                ...
                assertThat(Computer(intCode = intCode).run(), equalTo(listOf(1, 1, 0, 0, 99)))
            }
            ...
            internal fun `7 is NOT less than 2`() {
                ...
                assertThat(Computer(intCode = intCode).run(), equalTo(listOf(0, 0, 2, 0, 99)))
            }
            ...
            internal fun `less than supports parameter mode`() {
                ...
                assertThat(Computer(intCode = intCode).run(), equalTo(listOf(0, 3, 2, 0, 99)))
            }
        }
        ...
        inner class `We support equals instruction` {
            ...
            internal fun `7 is NOT equal to 1`() {
                ...
                assertThat(Computer(intCode = intCode).run(), equalTo(listOf(0, 1, 0, 0, 99)))
            }

            @Test
            internal fun `equals supports paramater mode`() {
                val intCode = IntCode(1108, 1, 3, 1, 99)
                assertThat(Computer(intCode = intCode).run(), equalTo(listOf(1108, 0, 3, 1, 99)))
            }
